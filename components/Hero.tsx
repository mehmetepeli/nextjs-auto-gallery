    ...
    return (
        <div className="hero">
            <div className="flex-1 pt-36 padding-x">
                ...
                <CustomButton
                    title="Explore Cars"
                    containerStyles="bg-primary-blue text-white rounded-full mt-10 hover:ring-offset-0 hover:ring"
                    handleClick={handleScroll}
                />
            </div>
            <div className="hero__image-container">
                <div className="hero__image">
                    <Image src="/volvo-xc60.webp" alt="Car" fill className="object-contain"/>
